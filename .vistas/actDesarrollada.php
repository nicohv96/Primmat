...
require_once ('../.controladores/mostrar/mostrar_tpCalificado.php');
?>
...
<section class="why-us" id="timeline">
    ...
    <div class="section-timeline fondo-timeline">
        <div class="container" id="mat">
           <form action="../.controladores/insert/insertar_resolucion.php" method="POST" enctype="multipart/form-data">
              ...
              <button type="submit" name="submit" class="btn btn-success btn-sm">Enviar</button>
          </form><br>
          <?php

          MOSTRAR_TPCALIFICADO();
